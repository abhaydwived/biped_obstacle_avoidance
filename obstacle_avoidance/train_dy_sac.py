...
from biped_env_dyobs import BipedWalkingEnv
...
eval_callback = EvalCallback(
    eval_env,
    best_model_save_path="./models_dy_obs/sac_best",
...
try:
    ...
    model.save("models_dy_obs/sac_biped_crashsave")

# ✅ Final save
os.makedirs("models_dy_obs ", exist_ok=True)
model.save("models_dy_obs/sac_biped_goal")
